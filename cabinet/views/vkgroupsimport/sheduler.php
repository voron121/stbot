<?php 
    ...
    $importController   = new VKGroupsImportController();
    $sheduler           = isset($rule->sheduler) ? $rule->sheduler : null; 
    $calendar           = $importController->shedulerCalendarConstruct($sheduler);
?>
        ...
        <div class="input-group col-md-12">
            ...
            <div class="sheduler_wraper">
                ...
                <div class="sheduler_time_text_wraper">
                    <?php foreach ($importController->time_dictionary as $key => $time):?> 
